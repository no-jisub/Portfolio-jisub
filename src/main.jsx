...
function App() {
  ...
  return <>
    <header className={scrolled ? 'site-header scrolled' : 'site-header'}>
      ...
      <nav aria-label="주요 섹션"><a href="#now">Now</a><a href="#style">Style</a><a href="#contact">Contact</a></nav>
    ...
    <main id="top">
      ...
      <section id="contact" className="contact section-shell" aria-labelledby="contact-title">
        <div className="contact-card"><p className="section-label">05 / CONTACT</p><h2 id="contact-title">프로젝트와 기술 이야기,<br /><em>편하게 연결해요.</em></h2><p className="contact-note">새로운 문제를 함께 정리하거나, 작동하는 서비스를 만들고 싶은 이야기를 기다립니다.</p><a className="contact-link" href="https://github.com/no-jisub" target="_blank" rel="noreferrer"><GithubIcon /> github.com/no-jisub <Arrow /></a></div>
      </section>
    </main>
